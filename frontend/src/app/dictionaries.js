export const dictionaries = {
  ru: {
    ...
    onlyOwnerCanStartGame: 'Запустить игру может только владелец комнаты.',
    needReadyPlayers: 'Нужно минимум 2 готовых игрока.',
    userNotInRoom: 'Пользователь не находится в комнате.',
    gameNotStarted: 'Игра ещё не началась.',
    notYourTurn: 'Сейчас не ваш ход.',
    cardCodeRequired: 'Нужно указать карту для действия.',
    cardNotInHand: 'Карты нет в руке.',
  ...
  en: {
    ...
    onlyOwnerCanStartGame: 'Only owner can start game.',
    needReadyPlayers: 'Need at least 2 ready players.',
    userNotInRoom: 'User is not in room.',
    gameNotStarted: 'Game not started.',
    notYourTurn: 'Not your turn.',
    cardCodeRequired: 'Card code is required for this action.',
