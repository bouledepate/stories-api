...
use Stories\Application\Rooms\ReadyRoom\ReadyRequest;
...
final class ReadyAction extends JsonAction
{
    public function __construct(
        private readonly ReadyRoomHandler $handler,
    ...
    {
        try {
            $dto = ReadyRequest::fromArray($this->body($request));
