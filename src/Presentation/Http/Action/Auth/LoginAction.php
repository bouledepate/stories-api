...
final class LoginAction extends JsonAction
{
    ...
    {
        try {
            $dto = LoginRequest::fromArray($this->body($request));
            $this->validator->validate($dto);

            return $this->respond($request, $response, $this->handler->handle($dto)->toArray());
