(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))n(i);new MutationObserver(i=>{for(const d of i)if(d.type==="childList")for(const m of d.addedNodes)m.tagName==="LINK"&&m.rel==="modulepreload"&&n(m)}).observe(document,{childList:!0,subtree:!0});function s(i){const d={};return i.integrity&&(d.integrity=i.integrity),i.referrerPolicy&&(d.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?d.credentials="include":i.crossOrigin==="anonymous"?d.credentials="omit":d.credentials="same-origin",d}function n(i){if(i.ep)return;i.ep=!0;const d=s(i);fetch(i.href,d)}})();const e={apiBase:window.location.origin,wsUrl:`ws://${window.location.hostname}:8081`,token:localStorage.getItem("stories_token")||"",user:null,activeRoom:null,activeTab:"home",homeLobbies:[],lobbyCatalog:[],lobbyFilters:{visibility:"all",password:"all",limit:20},socket:null,lang:localStorage.getItem("stories_lang")||"ru",theme:localStorage.getItem("stories_theme")||"dark",authOpen:!1,authMode:"login"},v={ru:{appTag:"Stories",title:"Control Center",subtitle:"Комнаты, профиль, админка и live debug в одном месте.",login:"Вход",register:"Регистрация",logout:"Выйти",notAuthorized:"Не авторизованы",signedAs:"Вы вошли как",navHome:"Комнаты",navProfile:"Профиль",navLobbies:"Лобби",navAdmin:"Админ",navDebug:"Debug",openAuth:"Войти / Регистрация",close:"Закрыть",authTitle:"Авторизация",authHint:"Откройте аккаунт или войдите в существующий.",username:"username",password:"password",createAccount:"Создать аккаунт",loginSuccess:"Успешный вход.",registerSuccess:"Аккаунт создан и выполнен вход.",homeNeedAuth:"Выполните вход для доступа к комнатам.",roomsTitle:"Комнаты",createRoom:"Создать комнату",roomName:"Название комнаты",connectCode:"Войти по invite-коду",connect:"Подключиться",spectator:"Зайти как spectator",ready:"Готово.",roomCreated:"Комната создана. Invite code:",roomJoinSuccess:"Подключение успешно. Room:",profileTitle:"Профиль пользователя",profileEdit:"Редактирование",newPassword:"Новый пароль (опционально)",saveProfile:"Сохранить профиль",stats:"Статистика",needAuthProfile:"Сначала авторизуйтесь.",profileUpdated:"Профиль обновлен.",passwordChanged:"Пароль успешно изменён.",currentPassword:"Текущий пароль",nextPassword:"Новый пароль",changePassword:"Сменить пароль",wins:"Победы",losses:"Поражения",vt:"Victory tokens",elim3:"Eliminated with 3",adminTitle:"Админ-панель (RBAC)",deckLoad:"Загрузка колоды",loadCards:"Показать cards",loadEffects:"Показать effects",patchCard:"Patch card",cardCode:"cardCode",newName:"Новое имя",newText:"Новый текст",valueOrEmpty:"value (или пусто)",effectKey:"effectKey",enabled:"enabled",applyPatch:"Применить PATCH",cardsLoaded:"Cards для {deck} загружены.",effectsLoaded:"Effects загружены.",cardUpdated:"Карта обновлена.",debugTitle:"Debug",oldInterface:"Техпанель для API и WebSocket.",checkHealth:"Проверить /health",waitingRequest:"Ожидание запроса…",websocket:"WebSocket",connectWs:"Подключиться",subscribe:"Подписаться",sendPing:"Ping",sendEvent:"Отправить room_event",wsNotConnected:"Не подключено",wsConnected:"WebSocket подключен",wsClosed:"WebSocket закрыт",wsError:"WebSocket ошибка",connectSocketFirst:"Сначала подключите сокет",healthError:"Ошибка",unknownError:"Неизвестная ошибка",httpError:"Ошибка HTTP {status}",invalidCredentials:"Неверный логин или пароль.",currentPasswordInvalid:"Текущий пароль указан неверно.",userExists:"Такой username уже занят.",unauthorized:"Требуется авторизация.",forbidden:"Недостаточно прав.",roomNotFound:"Комната не найдена.",inviteInvalid:"Некорректный invite-код.",validationFailed:"Проверьте корректность введенных данных.",serverUnavailable:"Сервер временно недоступен. Повторите позже.",invalidUrl:"Некорректный URL.",roomPasswordRequired:"Для входа в это лобби нужен пароль.",roomPasswordInvalid:"Неверный пароль лобби.",navControl:"Control Panel",heroTitle:"Stories: project-visual landing",heroSubtitle:"Создавайте комнаты и подключайтесь к игре за секунды.",heroCreate:"Создать комнату",heroJoin:"Присоединиться",roomDetails:"Текущая комната",roomCode:"Код приглашения",roomOwner:"Владелец",roomParticipants:"Участники",roomSpectators:"Зрители",roomActions:"Действия с комнатой",leaveRoom:"Покинуть комнату",refreshRoom:"Обновить состояние",markReady:"Я готов",startGame:"Запустить игру",youLabel:"вы",authRequiredAction:"Для этого действия войдите в аккаунт.",switchToLogin:"Уже есть аккаунт? Войти",switchToRegister:"Нет аккаунта? Регистрация",themeDark:"Тёмная",themeLight:"Светлая",controlPanelTitle:"Control Panel",controlPanelHint:"Только для администраторов: управление данными и live debug.",lobbyTitle:"Список лобби",lobbyHint:"Фильтруйте публичные и закрытые лобби.",visibilityAll:"Все",visibilityPublic:"Публичные",visibilityPrivate:"Закрытые",passwordAll:"Любые",passwordWith:"С паролем",passwordWithout:"Без пароля",loadLobbies:"Обновить список",lobbyNoItems:"Лобби не найдены",lobbyHasPassword:"Пароль",lobbyNoPassword:"Без пароля",joinLobby:"Войти в лобби",roomPassword:"Пароль лобби (если нужен)"},en:{appTag:"Stories",title:"Control Center",subtitle:"Rooms, profile, admin panel and live debug in one place.",login:"Sign in",register:"Sign up",logout:"Logout",notAuthorized:"Not authorized",signedAs:"Signed in as",navHome:"Rooms",navProfile:"Profile",navLobbies:"Lobbies",navAdmin:"Admin",navDebug:"Debug",openAuth:"Login / Register",close:"Close",authTitle:"Authentication",authHint:"Create an account or sign in.",username:"username",password:"password",createAccount:"Create account",loginSuccess:"Signed in successfully.",registerSuccess:"Account created and signed in.",homeNeedAuth:"Sign in to access rooms.",roomsTitle:"Rooms",createRoom:"Create room",roomName:"Room name",connectCode:"Join by invite code",connect:"Connect",spectator:"Join as spectator",ready:"Ready.",roomCreated:"Room created. Invite code:",roomJoinSuccess:"Connected successfully. Room:",profileTitle:"User profile",profileEdit:"Edit profile",newPassword:"New password (optional)",saveProfile:"Save profile",stats:"Stats",needAuthProfile:"Sign in first.",profileUpdated:"Profile updated.",passwordChanged:"Password changed successfully.",currentPassword:"Current password",nextPassword:"New password",changePassword:"Change password",wins:"Wins",losses:"Losses",vt:"Victory tokens",elim3:"Eliminated with 3",adminTitle:"Admin panel (RBAC)",deckLoad:"Load deck",loadCards:"Show cards",loadEffects:"Show effects",patchCard:"Patch card",cardCode:"cardCode",newName:"New name",newText:"New text",valueOrEmpty:"value (or empty)",effectKey:"effectKey",enabled:"enabled",applyPatch:"Apply PATCH",cardsLoaded:"Cards for {deck} loaded.",effectsLoaded:"Effects loaded.",cardUpdated:"Card updated.",debugTitle:"Debug",oldInterface:"Technical panel for API and WebSocket.",checkHealth:"Check /health",waitingRequest:"Waiting for request…",websocket:"WebSocket",connectWs:"Connect",subscribe:"Subscribe",sendPing:"Ping",sendEvent:"Send room_event",wsNotConnected:"Not connected",wsConnected:"WebSocket connected",wsClosed:"WebSocket closed",wsError:"WebSocket error",connectSocketFirst:"Connect socket first",healthError:"Error",unknownError:"Unknown error",httpError:"HTTP error {status}",invalidCredentials:"Invalid username or password.",currentPasswordInvalid:"Current password is invalid.",userExists:"This username is already taken.",unauthorized:"Authorization required.",forbidden:"Not enough permissions.",roomNotFound:"Room not found.",inviteInvalid:"Invalid invite code.",validationFailed:"Please check input values.",serverUnavailable:"Server is temporarily unavailable. Try again later.",invalidUrl:"Invalid URL.",roomPasswordRequired:"Lobby password is required.",roomPasswordInvalid:"Invalid lobby password.",navControl:"Control Panel",heroTitle:"Stories: project visual landing",heroSubtitle:"Create rooms and join matches in seconds.",heroCreate:"Create room",heroJoin:"Join room",roomDetails:"Current room",roomCode:"Invite code",roomOwner:"Owner",roomParticipants:"Participants",roomSpectators:"Spectators",roomActions:"Room actions",leaveRoom:"Leave room",refreshRoom:"Refresh state",markReady:"Mark ready",startGame:"Start game",youLabel:"you",authRequiredAction:"Please sign in to continue.",switchToLogin:"Already have an account? Sign in",switchToRegister:"No account yet? Sign up",themeDark:"Dark",themeLight:"Light",controlPanelTitle:"Control Panel",controlPanelHint:"Admin-only area for content management and live debug.",lobbyTitle:"Lobby list",lobbyHint:"Filter public and private lobbies.",visibilityAll:"All",visibilityPublic:"Public",visibilityPrivate:"Private",passwordAll:"Any",passwordWith:"With password",passwordWithout:"Without password",loadLobbies:"Refresh list",lobbyNoItems:"No lobbies found",lobbyHasPassword:"Password",lobbyNoPassword:"No password",joinLobby:"Join lobby",roomPassword:"Lobby password (if required)"}},t=(o,a={})=>{const s=v[e.lang]?.[o]??v.ru[o]??o;return Object.entries(a).reduce((n,[i,d])=>n.replaceAll(`{${i}}`,String(d)),s)},$=()=>e.token?{Authorization:`Bearer ${e.token}`}:{},P=(o,a)=>{const s=String(o||"").toUpperCase(),n={INVALID_CREDENTIALS:"invalidCredentials",USER_EXISTS:"userExists",UNAUTHORIZED:"unauthorized",FORBIDDEN:"forbidden",ROOM_NOT_FOUND:"roomNotFound",INVALID_INVITE_CODE:"inviteInvalid",INVITE_CODE_NOT_FOUND:"inviteInvalid",ROOM_PASSWORD_REQUIRED:"roomPasswordRequired",ROOM_PASSWORD_INVALID:"roomPasswordInvalid",CURRENT_PASSWORD_INVALID:"currentPasswordInvalid",VALIDATION_ERROR:"validationFailed"};return n[s]?n[s]:a===401?"unauthorized":a===403?"forbidden":a>=500?"serverUnavailable":null},k=(o,a,s)=>{const n=P(a?.code||a?.errorCode,o);return n?{key:n,message:t(n)}:{key:null,message:a?.message||a?.error||s||t("httpError",{status:o})}},l=async(o,a={})=>{let s;try{s=await fetch(`${e.apiBase.replace(/\/$/,"")}${o}`,{...a,headers:{"Content-Type":"application/json",...a.headers||{},...$(),Locale:e.lang}})}catch{throw new Error(t("serverUnavailable"))}const n=await s.text();let i={};try{i=n?JSON.parse(n):{}}catch{i={}}if(!s.ok){const d=k(s.status,i,n),m=new Error(d.message||t("unknownError"));throw m.code=d.key,m.status=s.status,m}return i},u=o=>{const a=document.createElement("div");return a.textContent=String(o??""),a.innerHTML},c=(o,a=256)=>{const s=document.querySelector(o);return s?String(s.value??"").trim().slice(0,a):""},y=(o,a)=>{let s;try{s=new URL(String(o||"").trim())}catch{throw new Error(t("invalidUrl"))}if(!a.includes(s.protocol))throw new Error(t("invalidUrl"));return s.toString().replace(/\/$/,"")},r=(o,a,s=!1)=>{const n=document.querySelector(`#${o}`);n&&(n.textContent=a,n.classList.toggle("ok",s))},b=o=>{const a=document.querySelector("#debugLog");if(!a)return;const s=document.createElement("div");s.textContent=`[${new Date().toLocaleTimeString()}] ${typeof o=="string"?o:JSON.stringify(o)}`,a.prepend(s)},h=(o,a="login")=>{e.authOpen=!0,e.authMode=a,o()},C=o=>{document.querySelectorAll("[data-tab]").forEach(a=>{a.addEventListener("click",()=>{e.activeTab=a.dataset.tab,o()})}),document.querySelectorAll("[data-lang]").forEach(a=>{a.addEventListener("click",()=>{e.lang=a.dataset.lang,localStorage.setItem("stories_lang",e.lang),o()})}),document.querySelectorAll("[data-theme]").forEach(a=>{a.addEventListener("click",()=>{e.theme=a.dataset.theme,localStorage.setItem("stories_theme",e.theme),o()})}),document.querySelector('[data-act="toggleAuth"]')?.addEventListener("click",()=>h(o,"login")),document.querySelector('[data-act="heroCreate"]')?.addEventListener("click",()=>{if(!e.user)return h(o,"login");document.querySelector("#roomName")?.focus()}),document.querySelector('[data-act="heroJoin"]')?.addEventListener("click",()=>{if(!e.user)return h(o,"login");document.querySelector("#inviteCode")?.focus()}),document.querySelectorAll('[data-act="closeAuth"]').forEach(a=>{a.addEventListener("click",()=>{e.authOpen=!1,o()})}),document.querySelector('[data-act="logout"]')?.addEventListener("click",()=>{e.token="",e.user=null,e.activeRoom=null,e.authOpen=!1,localStorage.removeItem("stories_token"),o()})},E=async(o,a)=>{document.querySelector('[data-act="switchAuthMode"]')?.addEventListener("click",()=>{e.authMode=e.authMode==="login"?"register":"login",o()}),document.querySelector('[data-act="authSubmit"]')?.addEventListener("click",async()=>{const s=e.authMode==="login"?"/auth/login":"/auth/register",n=e.authMode==="login"?t("loginSuccess"):t("registerSuccess");try{const i=await l(s,{method:"POST",body:JSON.stringify({username:c("#authUsername",64),password:c("#authPassword",128)})});e.token=i.accessToken,localStorage.setItem("stories_token",e.token),await a(),r("authStatus",n,!0),e.authOpen=!1,o()}catch(i){r("authStatus",i.message)}})},R=o=>{const a=()=>e.activeRoom?.roomId?!0:(r("homeStatus",t("roomNotFound")),!1);document.querySelector('[data-act="createRoom"]')?.addEventListener("click",async()=>{if(!e.user)return h(o,"login");try{e.activeRoom=await l("/rooms",{method:"POST",body:JSON.stringify({name:c("#roomName",64),isPublic:!!document.querySelector("#roomIsPublic")?.checked,password:c("#roomPassword",128)})}),r("homeStatus",`${t("roomCreated")} ${e.activeRoom.inviteCode}`,!0),o()}catch(s){r("homeStatus",s.message)}}),document.querySelector('[data-act="joinByCode"]')?.addEventListener("click",async()=>{if(!e.user)return h(o,"login");try{e.activeRoom=await l("/rooms/join-by-code",{method:"POST",body:JSON.stringify({inviteCode:c("#inviteCode",6).toUpperCase(),spectator:!!document.querySelector("#joinAsSpectator")?.checked,password:c("#joinPassword",128)})}),r("homeStatus",`${t("roomJoinSuccess")} ${e.activeRoom.roomId}`,!0),o()}catch(s){r("homeStatus",s.message)}}),document.querySelector('[data-act="refreshRoom"]')?.addEventListener("click",async()=>{if(a())try{e.activeRoom=await l(`/rooms/${encodeURIComponent(e.activeRoom.roomId)}`),r("homeStatus",t("ready"),!0),o()}catch(s){r("homeStatus",s.message)}}),document.querySelector('[data-act="readyRoom"]')?.addEventListener("click",async()=>{if(a())try{e.activeRoom=await l(`/rooms/${encodeURIComponent(e.activeRoom.roomId)}/ready`,{method:"POST"}),r("homeStatus",t("ready"),!0),o()}catch(s){r("homeStatus",s.message)}}),document.querySelector('[data-act="startGame"]')?.addEventListener("click",async()=>{if(a())try{e.activeRoom=await l(`/rooms/${encodeURIComponent(e.activeRoom.roomId)}/start`,{method:"POST"}),r("homeStatus",t("ready"),!0),o()}catch(s){r("homeStatus",s.message)}}),document.querySelector('[data-act="leaveRoom"]')?.addEventListener("click",async()=>{if(a())try{await l(`/rooms/${encodeURIComponent(e.activeRoom.roomId)}/leave`,{method:"POST"}),e.activeRoom=null,r("homeStatus",t("ready"),!0),o()}catch(s){r("homeStatus",s.message)}}),document.querySelectorAll('[data-act="joinLobby"]').forEach(s=>{s.addEventListener("click",async()=>{if(!e.user)return h(o,"login");const n=s.dataset.roomId;if(n)try{const i=window.prompt(t("roomPassword"))||"";e.activeRoom=await l(`/rooms/${encodeURIComponent(n)}/join`,{method:"POST",body:JSON.stringify({spectator:!1,password:i})}),e.activeTab="home",r("homeStatus",`${t("roomJoinSuccess")} ${e.activeRoom.roomId}`,!0),o()}catch(i){r("homeStatus",i.message)}})})},L=o=>{const a=async()=>{try{e.lobbyCatalog=(await l(`/lobbies?visibility=${encodeURIComponent(e.lobbyFilters.visibility)}&password=${encodeURIComponent(e.lobbyFilters.password)}&limit=${e.lobbyFilters.limit}`)).items||[],r("lobbyStatus",t("ready"),!0),o()}catch(s){r("lobbyStatus",s.message)}};document.querySelector('[data-act="loadLobbies"]')?.addEventListener("click",async()=>{e.lobbyFilters.visibility=c("#lobbyVisibility",16)||"all",e.lobbyFilters.password=c("#lobbyPasswordFilter",20)||"all",e.lobbyFilters.limit=Number(c("#lobbyLimit",3)||"20"),await a()}),document.querySelectorAll('[data-act="joinLobby"]').forEach(s=>{s.addEventListener("click",async()=>{if(!e.user)return h(o,"login");const n=s.dataset.roomId;if(n)try{const i=window.prompt(t("roomPassword"))||"";e.activeRoom=await l(`/rooms/${encodeURIComponent(n)}/join`,{method:"POST",body:JSON.stringify({spectator:!1,password:i})}),e.activeTab="home",r("homeStatus",`${t("roomJoinSuccess")} ${e.activeRoom.roomId}`,!0),o()}catch(i){r("lobbyStatus",i.message)}})})},I=o=>{document.querySelector('[data-act="saveProfile"]')?.addEventListener("click",async()=>{try{const s={username:c("#profileUsername",64)};e.user=await l("/auth/me",{method:"PATCH",body:JSON.stringify(s)}),r("profileStatus",t("profileUpdated"),!0),o()}catch(a){r("profileStatus",a.message)}}),document.querySelector('[data-act="changePassword"]')?.addEventListener("click",async()=>{try{await l("/auth/change-password",{method:"POST",body:JSON.stringify({currentPassword:c("#currentPassword",128),newPassword:c("#nextPassword",128)})});const a=document.querySelector("#currentPassword"),s=document.querySelector("#nextPassword");a&&(a.value=""),s&&(s.value=""),r("profileStatus",t("passwordChanged"),!0)}catch(a){r("profileStatus",a.message)}})},A=()=>{const o=document.querySelector("#adminOutput");o&&(document.querySelector('[data-act="loadCards"]')?.addEventListener("click",async()=>{try{const a=c("#adminDeck",16),s=await l(`/admin/cards?deck=${encodeURIComponent(a)}`);o.textContent=JSON.stringify(s,null,2),r("adminStatus",t("cardsLoaded",{deck:a}),!0)}catch(a){r("adminStatus",a.message)}}),document.querySelector('[data-act="loadEffects"]')?.addEventListener("click",async()=>{try{const a=await l("/admin/effects");o.textContent=JSON.stringify(a,null,2),r("adminStatus",t("effectsLoaded"),!0)}catch(a){r("adminStatus",a.message)}}),document.querySelector('[data-act="patchCard"]')?.addEventListener("click",async()=>{try{const a=c("#adminDeck",16),s=c("#adminCardCode",64),n={name:c("#adminCardName",64),text:c("#adminCardText",512),enabled:!!document.querySelector("#adminEnabled")?.checked},i=c("#adminCardValue",16),d=c("#adminEffectKey",64);i!==""&&(n.value=Number(i)),d!==""&&(n.effectKey=d);const m=await l(`/admin/cards/${encodeURIComponent(a)}/${encodeURIComponent(s)}`,{method:"PATCH",body:JSON.stringify(n)});o.textContent=JSON.stringify(m,null,2),r("adminStatus",t("cardUpdated"),!0)}catch(a){r("adminStatus",a.message)}}))},T=()=>{const o={apiBase:document.querySelector("#apiBase"),checkHealth:document.querySelector("#checkHealth"),wsUrl:document.querySelector("#wsUrl"),wsConnect:document.querySelector("#wsConnect"),roomId:document.querySelector("#roomId"),subscribeRoom:document.querySelector("#subscribeRoom"),sendPing:document.querySelector("#sendPing"),sendEvent:document.querySelector("#sendEvent"),eventName:document.querySelector("#eventName")};!o.apiBase||!o.wsUrl||!o.checkHealth||!o.wsConnect||(o.checkHealth.addEventListener("click",async()=>{try{e.apiBase=y(o.apiBase.value,["http:","https:"]);const a=await l("/health");r("healthStatus",`OK: ${JSON.stringify(a)}`,!0)}catch(a){r("healthStatus",`${t("healthError")}: ${a.message}`)}}),o.wsConnect.addEventListener("click",()=>{try{e.wsUrl=y(o.wsUrl.value,["ws:","wss:"])}catch(a){r("wsStatus",a.message);return}e.socket?.close(),e.socket=new WebSocket(e.wsUrl),e.socket.onopen=()=>{r("wsStatus",t("wsConnected"),!0),b("socket open")},e.socket.onmessage=a=>{try{b(JSON.parse(a.data))}catch{b(a.data)}},e.socket.onclose=()=>{r("wsStatus",t("wsClosed")),b("socket close")},e.socket.onerror=()=>{r("wsStatus",t("wsError")),b("socket error")}}),o.subscribeRoom?.addEventListener("click",()=>{if(!e.socket||e.socket.readyState!==WebSocket.OPEN)return b(t("connectSocketFirst"));e.socket.send(JSON.stringify({type:"subscribe_room",roomId:c("#roomId",64)}))}),o.sendPing?.addEventListener("click",()=>{if(!e.socket||e.socket.readyState!==WebSocket.OPEN)return b(t("connectSocketFirst"));e.socket.send(JSON.stringify({type:"ping"}))}),o.sendEvent?.addEventListener("click",()=>{if(!e.socket||e.socket.readyState!==WebSocket.OPEN)return b(t("connectSocketFirst"));e.socket.send(JSON.stringify({type:"room_event",roomId:c("#roomId",64),event:c("#eventName",128),data:{source:"frontend"}}))}))},N=()=>{if(!e.authOpen||e.user)return"";const o=e.authMode==="login";return`
...
`,q=()=>{const o=e.homeLobbies;return`
      ...
      <div class="lobby-list">
        ${o.length===0?`<p>${t("lobbyNoItems")}</p>`:o.map(a=>`
          <article class="lobby-item">
            ...
            <button class="secondary" data-act="joinLobby" data-room-id="${u(a.roomId)}">${t("joinLobby")}</button>
          </article>
        `).join("")}
      </div>
    </section>
  ...
  `:`<section class="lobby-quick-actions"><p>${t("authRequiredAction")}</p></section>`,w=o=>{const a=e.user?.id===o.userId;return`
  ...
  `},D=()=>{if(!e.activeRoom)return"";const o=Array.isArray(e.activeRoom.participants)?e.activeRoom.participants:[],a=o.filter(n=>n.role!=="spectator"),s=o.filter(n=>n.role==="spectator");return`
    <article class="room-panel">
      ...
      <div class="room-lists">
        <div>
          ...
          <ul class="participant-list">${a.map(w).join("")}</ul>
        </div>
        <div>
          <h4>${t("roomSpectators")} (${s.length})</h4>
          <ul class="participant-list">${s.map(w).join("")}</ul>
        </div>
      </div>
      <div class="stack">
        <h4>${t("roomActions")}</h4>
  ...
  <div class="lobby-list topgap">
    ${e.lobbyCatalog.length===0?`<article><p>${t("lobbyNoItems")}</p></article>`:e.lobbyCatalog.map(o=>`
      <article class="lobby-item">
        ...
        <button class="secondary" data-act="joinLobby" data-room-id="${u(o.roomId)}">${t("joinLobby")}</button>
      </article>
    `).join("")}
  </div>
...
`,_=()=>e.user?`
  ...
  `:`<h2>${t("profileTitle")}</h2><div class="status">${t("needAuthProfile")}</div>`,J=()=>`
  <article>
    <h3>${t("deckLoad")}</h3>
    <div class="stack">
      <select id="adminDeck">
...
`,j=()=>{const o=e.user?`<div class="session ok">${t("signedAs")} <b>${u(e.user.username)}</b> (${u(e.user.role)})</div>`:`<div class="session">${t("notAuthorized")}</div>`;return`
  <main class="layout ${e.theme}">
    ...
    <section class="panel ${e.activeTab==="home"?"":"hidden"} cinematic-panel">${H()}</section>
    <section class="panel ${e.activeTab==="lobbies"?"":"hidden"} cinematic-panel">${F()}</section>
    <section class="panel ${e.activeTab==="profile"?"":"hidden"} cinematic-panel">${_()}</section>
    ${e.user?.role==="admin"?`<section class="panel ${e.activeTab==="control"?"":"hidden"}">${x()}</section>`:""}

    ${N()}
  </main>`},g=document.querySelector("#app"),f=async()=>{if(e.token)try{e.user=await l("/auth/me")}catch{e.user=null,e.token="",localStorage.removeItem("stories_token")}},p=()=>{g&&(g.innerHTML=j(),C(p),e.activeTab==="home"&&R(p),e.activeTab==="lobbies"&&L(p),e.activeTab==="profile"&&I(p),e.activeTab==="control"&&e.user?.role==="admin"&&(A(),T()),e.authOpen&&!e.user&&E(p,f))},S=async(o="public",a=4)=>{try{const s=await l(`/lobbies?visibility=${encodeURIComponent(o)}&limit=${a}`);o==="public"&&(e.homeLobbies=s.items||[]),o==="all"&&(e.lobbyCatalog=s.items||[])}catch{o==="public"&&(e.homeLobbies=[]),o==="all"&&(e.lobbyCatalog=[])}};await f();await S("public",4);await S("all",e.lobbyFilters.limit);p();
//# sourceMappingURL=index-DEk2TNIP.js.map
