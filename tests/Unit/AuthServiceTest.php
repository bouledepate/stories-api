...
final class AuthServiceTest extends TestCase
{
    public function testRegisterHashesPasswordAndUsesPlayerRole(): void
    {
        ...
        $service = new AuthService($db, new JwtService('test-secret-1234567890'), new PasswordHasher());
    ...
    public function testLoginVerifiesArgonHash(): void
    {
        ...
        $service = new AuthService($db, new JwtService('test-secret-1234567890'), $hasher);
